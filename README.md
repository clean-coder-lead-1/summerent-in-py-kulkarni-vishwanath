...
**Improve the documentation of the functions/methods used, follow the principle that each function has to do a single job and not multiple tasks, make functions less complexx and easy to understand, do not use too many function calls within functions.**
